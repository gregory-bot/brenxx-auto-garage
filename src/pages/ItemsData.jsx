const ourItemsData = [
  {
    ...
    },
    {
      id: 4,
      title: 'Car Battery',
      description: 'Long-lasting maintenance-free batteries for all car types.',
      image: 'https://images.pexels.com/photos/30421264/pexels-photo-30421264/free-photo-of-close-up-of-modified-bmw-engine.jpeg?auto=compress&cs=tinysrgb&w=1200'
    },
    {
      id: 5,
      title: 'LED Headlights',
      description: 'Energy-efficient LED headlights for improved night visibility.',
      image: 'https://i.postimg.cc/85YLTG40/lights.jpg'
    },
    {
      id: 6,
      title: 'Windshield Wipers',
      description: 'High-performance wipers for clear vision during rain.',
      image: 'https://media.istockphoto.com/id/1053942914/photo/the-work-of-windshield-wipers-brushes-and-an-evening-sunbeam.jpg?b=1&s=612x612&w=0&k=20&c=ZYxMvcUC6pcbpkvDQZzihPy-7u_QlIRMYjutTaYPbaQ='
    },
    {
      id: 7,
      title: 'Engine Oil',
